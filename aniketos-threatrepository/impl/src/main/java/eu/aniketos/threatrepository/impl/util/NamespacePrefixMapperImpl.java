 ...
 */
/*
package eu.aniketos.wp4.components.threatrepository.impl.util;
...
public class NamespacePrefixMapperImpl extends NamespacePrefixMapper {
    ...
    public String getPreferredPrefix(String namespaceUri, String suggestion, boolean requirePrefix) {
        ...
        if( "http://www.w3.org/2001/XMLSchema-instance".equals(namespaceUri) )
            return "xsi";
        // Default namespace for all generated XML files should be this one:
        if( "http://www.aniketos.eu".equals(namespaceUri) )
            return "a";
    ...
    public String[] getPreDeclaredNamespaceUris() {
        return new String[] { "http://www.aniketos.eu", "http://www.w3.org/2001/XMLSchema-instance" };
//        return new String[] { };
    }
}*/